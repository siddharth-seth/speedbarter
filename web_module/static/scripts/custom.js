...
jQuery.noConflict(); jQuery(document).ready(function(){
    ...
    jQuery(".roadmap").live('click',function(){
    	jQuery("#gMap").gmap3({map:{options:{mapTypeId: google.maps.MapTypeId.ROADMAP}}}); //hybrid, satellite, roadmap, terrain
    ...
    jQuery(".satellite").live('click',function(){
    	jQuery("#gMap").gmap3({map:{options:{mapTypeId: google.maps.MapTypeId.SATELLITE}}}); //hybrid, satellite, roadmap, terrain
